Create one horizontal animation strip for Codex pet `yushi`, state `running-right`.
...
Identity: same pet in every frame: Base only for user approval. Preserve the reference character colors: warm cream cup body, orange cup rim and top tab, white cat face/body, pink inner ears, dark brown coffee-bean ornament on upper right, dark brown/black simple cat eyes nose mouth and short whisker marks. Full-body centered standing pose, no crop.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
